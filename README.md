...
## �����L���O / Supabase �Z�b�g�A�b�v
- Supabase �� scores �e�[�u�����쐬�i`supabase_scores.sql` �� SQL �����̂܂܎��s�j
- `.env` �� `SUPABASE_URL` �� `SUPABASE_SERVICE_ROLE_KEY` ��ݒ�iservice role �̓T�[�o�[��p�E�t�����g����J�j
- �T�[�o�[ API�iHono�j
  - `POST /api/score` : `{ songId, mode: 'cursor'|'body', score, maxCombo, rank }` ��ۑ��i������ `{ ok: true }`�j
  - `GET /api/ranking?songId=...&mode=cursor|body` : score �~�� Top10 ��ԋp�imode �ȗ��j
- ����m�F��
