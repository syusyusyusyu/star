    ...
    <div className={`w-full rounded-2xl bg-black/40 border border-white/10 p-4 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.35)] flex flex-col ${className}`}>
      ...
      {loading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0 scrollbar-hide">
          <div className="grid grid-cols-[30px,1fr,80px,40px,120px] ranking-grid text-[10px] uppercase tracking-wide text-gray-400 font-semibold mb-1 sticky top-0 bg-black/60 backdrop-blur-md py-1 z-10 rounded-t-lg gap-2 px-2">
            <span>#</span>
            <span>Player</span>
            <span>Score</span>
            <span>Rank</span>
          ...
          <div className="space-y-1">
            {rows.map((row, index) => (
              <div
                ...
                className="grid grid-cols-[30px,1fr,80px,40px,120px] ranking-grid items-center text-xs font-mono text-gray-100 bg-white/5 hover:bg-white/10 transition rounded-lg px-2 py-1.5 border border-white/5 gap-2"
              >
                ...
                <div className="text-center text-[10px] text-gray-400 tabular-nums ranking-combo">
