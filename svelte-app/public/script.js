...
class GameManager {
	...
	createAudiencePenlights() {
		...
		// Add a keyframe animation for the swaying motion
			...
			const keyframes = `@keyframes sway { 0% { transform: rotate(-15deg); } 100% { transform: rotate(15deg); } }`;
			try {
...
// グローバル公開（game-loader.js が window.GameManager を参照するため）
window.GameManager = GameManager;
window.LiveStageVisuals = LiveStageVisuals;
